exports.activationMail = (data) => {
    ...
    <a href="http://localhost:8000/activation/${data._id}/${data.token}">Click here to activate your account!</a>
...
exports.passwordReset = (data) => {
    ...
    <a href="http://localhost:8000/password-reset/${data._id}/${data.token}">Reset password now!</a>
